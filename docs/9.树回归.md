...
def createTree(dataSet, leafType=regLeaf, errType=regErr, ops=(1, 4)):
    ...
    return retTree
```
[完整代码地址](https://github.com/apachecn/MachineLearning/blob/master/src/py2.x/9.RegTrees/regTrees.py): <https://github.com/apachecn/MachineLearning/blob/master/src/py2.x/9.RegTrees/regTrees.py>
...
[完整代码地址](https://github.com/apachecn/MachineLearning/blob/master/src/py2.x/9.RegTrees/treeExplore.py): <https://github.com/apachecn/MachineLearning/blob/master/src/py2.x/9.RegTrees/treeExplore.py>
