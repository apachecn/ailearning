...
![预测数值型数据回归首页](/img/9.TreeRegression/TreeRegression_headPage_xy.png "树回归首页")
...
![基于 CART 算法构建回归树的简单数据集](/img/9.TreeRegression/RegTree_1.png)  

用于测试回归树的分段常数数据集  
![用于测试回归树的分段常数数据集](/img/9.TreeRegression/RegTree_2.png)  
...
![分段线性数据](/img/9.TreeRegression/RegTree_3.png)
...
![模型树运行结果](/img/9.TreeRegression/RegTree_4.png)
...
![骑自行车速度和智商之间的关系](/img/9.TreeRegression/RegTree_5.png)
...
![GUI示例图](/img/9.TreeRegression/GUI示例图.png "GUI示例图")
...
![取得更好预测效果的GUI示例图](/img/9.TreeRegression/GUI更好的示例图.png "取得更好预测效果的GUI示例图")
