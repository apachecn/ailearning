...
[完整代码地址](https://github.com/apachecn/MachineLearning/blob/master/src/py2.x/15.BigData_MapReduce/pegasos.py): <https://github.com/apachecn/MachineLearning/blob/master/src/py2.x/15.BigData_MapReduce/pegasos.py>

运行方式：`python /opt/git/MachineLearning/src/python/15.BigData_MapReduce/mrSVM.py < input/15.BigData_MapReduce/inputFile.txt`
[MR版本的代码地址](https://github.com/apachecn/MachineLearning/blob/master/src/py2.x/15.BigData_MapReduce/mrSVM.py): <https://github.com/apachecn/MachineLearning/blob/master/src/py2.x/15.BigData_MapReduce/mrSVM.py>
