...
![决策树_首页](/img/3.DecisionTree/DecisionTree_headPage_xy.png "决策树首页")
...
![决策树-流程图](/img/3.DecisionTree/决策树-流程图.jpg "决策树示例流程图")
...
![海洋生物数据](/img/3.DecisionTree/DT_海洋生物数据.png)
...
![熵的计算公式](/img/3.DecisionTree/熵的计算公式.jpg)
