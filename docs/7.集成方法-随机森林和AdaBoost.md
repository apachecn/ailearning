...
[完整代码地址](https://github.com/apachecn/MachineLearning/blob/master/src/py2.x/7.RandomForest/randomForest.py): <https://github.com/apachecn/MachineLearning/blob/master/src/py2.x/7.RandomForest/randomForest.py>
...
[完整代码地址](https://github.com/apachecn/MachineLearning/blob/master/src/py2.x/7.AdaBoost/adaboost.py): <https://github.com/apachecn/MachineLearning/blob/master/src/py2.x/7.AdaBoost/adaboost.py>
