...
这是一般的神经网络应该有的结构： 
![这里写图片描述](media/15570320872343/20171119130251741.jpg)
...
它的网络结构如下： 
![这里写图片描述](media/15570320872343/20171129184524844.jpg)
其中每个圆圈可以看作是一个单元，而且每个单元做的事情也是一样的，因此可以折叠呈左半图的样子。用一句话解释RNN，就是**一个单元结构重复使用**。

RNN是一个序列到序列的模型，假设![-w88](media/15570320872343/15570321772488.jpg)是一个输入：“我是中国“，那么![-w54](media/15570320872343/15570322195709.jpg)就应该对应”是”，”中国”这两个，预测下一个词最有可能是什么？就是![-w31](media/15570320872343/15570322451341.jpg)应该是”人”的概率比较大。

因此，我们可以做这样的定义：

![-w416](media/15570320872343/15570322822857.jpg)
...
![-w200](media/15570320872343/15570322981095.jpg)
...
![-w160](media/15570320872343/15570323546017.jpg)


其中![-w21](media/15570320872343/15570323768890.jpg)就表示时刻t的输出。
...
![这里写图片描述](media/15570320872343/bi-directional-rnn.png) 
![-w347](media/15570320872343/15570324711246.jpg)

这里的![-w50](media/15570320872343/15570324937386.jpg)做的是一个拼接，如果他们都是1000x1维的，拼接在一起就是1000x2维的了。
...
深层双向RNN就是基于这么一个想法，他的输入有两方面，第一就是前一时刻的隐藏层传过来的信息![-w41](media/15570320872343/15570325271812.jpg)，和当前时刻上一隐藏层传过来的信息![-w167](media/15570320872343/15570325458791.jpg)，包括前向和后向的。 
![这里写图片描述](media/15570320872343/deep-bi-directional-rnn.png)

我们用公式来表示是这样的: 
![这里写图片描述](media/15570320872343/deep-bi-directional-rnn-hidden-layer.png) 
然后再利用最后一层来进行分类，分类公式如下： 
![这里写图片描述](media/15570320872343/deep-bi-directional-rnn-classification.png)

### 4.1 Pyramidal RNN

其他类似的网络还有Pyramidal RNN： 
![这里写图片描述](media/15570320872343/20171221152506461.jpg)
...
![-w202](media/15570320872343/15570325921406.jpg)

然后利用当前时刻的记忆，通过softmax分类器输出每个词出现的概率：

![-w144](media/15570320872343/15570326059642.jpg)

为了找出模型最好的参数，U，W，V，我们就要知道当前参数得到的结果怎么样，因此就要定义我们的损失函数，用交叉熵损失函数：

![-w252](media/15570320872343/15570326336949.jpg)

其中![-w14](media/15570320872343/15570326853547.jpg)
 t时刻的标准答案，是一个只有一个是1，其他都是0的向量； ![-w19](media/15570320872343/15570326727679.jpg)是我们预测出来的结果，与![-w14](media/15570320872343/15570327422935.jpg)
的维度一样，但它是一个概率向量，里面是每个词出现的概率。因为对结果的影响，肯定不止一个时刻，因此需要把所有时刻的造成的损失都加起来：

![-w300](media/15570320872343/15570327570018.jpg)

![](media/15570320872343/20171130091040277.jpg)
...
![](media/15570320872343/20171130091956686.jpg)

假设我们对E3的W求偏导：它的损失首先来源于预测的输出![-w19](media/15570320872343/15570327881131.jpg)
，预测的输出又是来源于当前时刻的记忆s3,当前的记忆又是来源于当前的输出和截止到上一时刻的记忆：![-w170](media/15570320872343/15570328132196.jpg)
因此，根据链式法则可以有:
![-w172](media/15570320872343/15570328255432.jpg)

但是，你会发现，![-w145](media/15570320872343/15570328436386.jpg)
，也就是s2里面的函数还包含了W，因此，这个链式法则还没到底，就像图上画的那样，所以真正的链式法则是这样的： 
![这里写图片描述](media/15570320872343/20171130094236429.jpg) 
...
![](media/15570320872343/20171129213601819.jpg)

最后我们不是要分类嘛，那在分类前，是不是已经拿到了图像的特征呀，那我们能不能把图像的特征拿出来，放到RNN的输入里，让他学习呢？

之前的RNN是这样的：

![-w238](media/15570320872343/15570328705596.jpg)

我们把图像的特征加在里面，可以得到：

![-w266](media/15570320872343/15570328817086.jpg)
